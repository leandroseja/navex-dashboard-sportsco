...
const CAMPOS_BANCO = [
    { key: 'nome', label: 'Nome da Loja', obrigatorio: true },
...
export default function ImportarLojas() {
    ...
    async function confirmarLimpar() {
        ...
        setLoading(true);
        try {
            const r = await fetch(`${API}/api/import/lojas/limpar?empresa=${empresa}`, {
    ...
    async function handleImportar(e) {
        ...
        try {
            ...
            const r = await fetch(`${API}/api/import/lojas`, {
    ...
    return (
        <PageLayout title="Importar Lojas">
                        ...
                        <div className="import-card">
                            ...
                            <div className="import-card-body">
                                ...
                                <div className="import-info-banner">
                                    ...
                                    ✅ Se a loja <strong>JÁ EXISTIR</strong>, as novas unidades de negócio serão <strong>ADICIONADAS</strong> (sem remover as existentes)<br />
                                    🆕 Se <strong>NÃO EXISTIR</strong>, um novo registro será criado
                                </div>
                                ...
                                <div className="import-section">
                                    ...
                                    <small style={{ display: 'block', color: 'var(--text-muted)', fontSize: '0.78rem', marginBottom: '0.6rem' }}>
                                        Serão adicionadas às lojas importadas (sem substituir as já existentes)
                                    </small>
                                ...
                                <div className="limpar-dados-box">
                                    ...
                                    <div className="limpar-dados-warning">
                                        ⚠️ Apagará <strong>todas as lojas</strong> da empresa selecionada antes de importar. Essa ação é irreversível.
                                    </div>
                                </div>
                    ...
                    <form onSubmit={handleImportar}>
                        <div className="import-card">
                            ...
                            <div className="import-card-body">
                                ...
                                <div className="import-actions">
                                    <button type="submit" className="btn-import-primary" disabled={loading}>
                                        {loading ? '⏳ Importando...' : '⬆️ Importar Lojas'}
                                    </button>
                    ...
                    <div className="import-card">
                        ...
                        <div className="import-card-body">
                            ...
                            <div className="import-actions">
                                ...
                                <a href="/lojas" className="btn-import-secondary">🏪 Ver Lojas</a>
                            </div>
                        </div>
                    </div>
                )}
            ...
            {showModal && (
                <div className="import-modal-overlay">
                    <div className="import-modal">
                        ...
                        <p>
                            Você está prestes a <strong>apagar TODAS as lojas</strong> da empresa <strong>{empresas.find(e => e.slug === empresa)?.nome || empresa}</strong>.<br /><br />
